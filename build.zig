...
pub fn build(b: *std.Build) void {
    ...
    // We will also create a module for our other entry point, 'main.zig'.
        ...
        exe_mod.addImport("lazymail_lib", lib_mod);
    ...
    {
        const tui_exe_mod = b.createModule(.{
            .root_source_file = b.path("src/main-tui.zig"),
            .target = target,
            .optimize = optimize,
        });
        ...
        tui_exe_mod.addImport("vaxis", vaxis.module("vaxis"));

        tui_exe_mod.addImport("lazymail_lib", lib_mod);

        //create executable
        const tui_exe = b.addExecutable(.{
            .name = "lazymail-tui",
            .root_module = tui_exe_mod,
        });
